...
export const HeroSection = () => {
  ...
  const codeSnippets = [
    "import { WebDeveloper } from 'the_mahamadou.dev';",
    "",
    "const developer = new WebDeveloper({",
    "  name: 'Mahamadou Dembele',",
    "  stack: ['PHP', 'Symfony', 'JavaScript', 'React'],",
    "  focus: 'Créer des applications web performantes et modernes',",
    "  status: 'À la recherche d’un stage en développement web'",
    "});",
    "",
    "await developer.launchPortfolio();",
    "// Projets : Applications Web, Tests Automatisés, APIs, Intégrations dynamiques",
    "",
    "developer.connect();",
    "console.log('🚀 Construisons ensemble des projets ambitieux !');"
  ];
  

  const achievements = [
    { number: "2+", label: "Années d'expérience en développement", icon: <Shield className="h-3 w-3" /> },
    { number: "10+", label: "Projets réalisés", icon: <TrendingUp className="h-3 w-3" /> },
    { number: "100%", label: "Implication dans chaque projet", icon: <Award className="h-3 w-3" /> },
    { number: "∞", label: "Lignes de code testées", icon: <Zap className="h-3 w-3" /> }
  ];
  ...
  >
    ...
    <div className="flex-1 text-center lg:text-left max-w-2xl mx-auto lg:mx-0">
      ...
      >
        <Briefcase className="h-4 w-4" /> 🚀 À la recherche d’un stage en
        développement web
      </motion.div>
      ...
      >
        ...
        <span className="text-primary font-semibold">
          développement web et l’automatisation des tests
        </span>
        , je conçois des applications modernes et performantes avec{" "}
        <span className="font-semibold">PHP, Symfony et JavaScript</span>.
        Je suis à la recherche d’un stage pour mettre mes compétences en
      ...
      >
        <div className="text-sm text-muted-foreground">
          🚀 <span className="text-primary font-semibold">Disponible
          immédiatement</span> pour un stage en développement web ou test
          automatique
        </div>
      </motion.div>
    </div>
